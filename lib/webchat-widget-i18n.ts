...
const vi: WidgetStrings = {
  ...
  offlineNotice: "Chúng tôi thường trả lời trong khung 09:00–22:00 (giờ Việt Nam). Để lại liên hệ để được báo khi có trả lời nhé.",
  ...
  paused: "Kênh chat tạm thời đóng. Vui lòng nhắn Zalo cho chúng tôi.",
