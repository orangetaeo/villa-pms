...
/** 발송 가능한 링크 종류 — /g(체크인) · /g/options(부가서비스) · /g/receipt(영수증). */
export type LinkKind = "checkin" | "options" | "receipt";
...
const BODY: Record<LinkKind, Record<TemplateLocale, string>> = {
  checkin: {
    ...
    vi: "[Villa GO] Hướng dẫn nhận phòng. Vui lòng đăng ký hộ chiếu và ký giấy đồng ý qua liên kết bên dưới. Xin cảm ơn.",
  ...
  options: {
    ...
    vi: "[Villa GO] Dịch vụ bổ sung. Bạn có thể đặt massage, tour, đưa đón và các dịch vụ khác qua liên kết bên dưới.",
  ...
  receipt: {
    ...
    vi: "[Villa GO] Bảng kê thanh toán khi trả phòng. Bạn có thể xem chi tiết sử dụng và hoàn tiền đặt cọc qua liên kết bên dưới.",
