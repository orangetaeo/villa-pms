...
// 부가서비스 매출 추이 — KRW·VND 분리 2계열 막대 (ADR-0019 후속, canViewFinance 전용)
  ...
  return (
    <ResponsiveContainer width="100%" height={240}>
      <BarChart data={data} margin={{ top: 8, right: 8, left: 0, bottom: 0 }} barGap={2}>
        ...
        />
        <Bar yAxisId="krw" dataKey="revenueKrw" name={krwLegend} fill={KRW} radius={[3, 3, 0, 0]} />
        <Bar yAxisId="vnd" dataKey="revenueVnd" name={vndLegend} fill={VND} radius={[3, 3, 0, 0]} />
      </BarChart>
    </ResponsiveContainer>
  );
}
