...
| 문서 | 내용 |
|---|---|
| docs/marketing/storyboard-m-villa-m1.md | **M villa M1 투어 쇼츠 스토리보드(테오 구술, 2026-07-23)** — 원본 540초 워크스루의 30컷 초 단위 목록 + 완급(fast/slow). ★클립이 8초여도 **화면에 나가는 건 앞 3~4초**라 피사체가 시작 직후에 와야 한다. 다음 세션 수정분(컷7 src88→80, 컷8 src120→96) 포함 |
